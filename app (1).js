// Professional Question Paper Generator - COMPLETE with ALL Features
class ProfessionalQuestionPaperGenerator {
    ...
    updateCOSelectionSection() {
        ...
        if (!coSelectionContainer) return;
    ...
    generatePaper() {
        ...
        if (coSelections.totalQuestions > 0) {
            ...
            if (num2mark + num4mark + num8mark + num13mark + num14mark + num15mark + num16mark === 0) {
                alert('Please specify at least one question in either CO selection or legacy mode');
                return;
            }
            ...
            const paper = this.createLegacyQuestionPaper({
    ...
    createLegacyQuestionPaper(config) {
        const paper = {
            header: {
                collegeInfo: this.collegeInfo,
                subjectInfo: this.subjectInfo,
